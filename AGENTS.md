...
| Current: multi-core (SMP) support | Pieces 1–4 COMPLETE and Dell Latitude 5590 verified; Piece 5 (Cross-Core Coordination & IPIs) COMPLETE in QEMU across BIOS & UEFI for 1/4/8 CPUs ([Piece 5 details](docs/roadmap/smp-piece5-ipi.md), [Piece 4 details](docs/roadmap/smp-piece4-scheduler.md), [Piece 3 details](docs/roadmap/smp-piece3-lock-discipline.md)). APIC ICR messaging, synchronous TLB shootdowns (SM14/SM15), and remote core wakeups verified. Physical Dell 5590 bare-metal verification is next. Piece 6 (PMM/VMM Re-Audit) will follow. |
