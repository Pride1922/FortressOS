...
| [S7_PLAN.md](S7_PLAN.md) | Staged implementation plan & acceptance checklist for Milestone S7 (Pipes and stream utilities). | **PHASES 1–3 COMPLETE**; Phase 4 implemented, acceptance pending |
| [S7_PHASE4.md](S7_PHASE4.md) | BSP-only external pipeline executor: loop shape, launch/wait separation, fd wiring, cleanup, error mapping and acceptance gates. | **IMPLEMENTED; USER TESTS PENDING** |
