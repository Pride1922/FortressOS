...
Status: **ALL SIX PIECES COMPLETE AND HARDWARE-VERIFIED (2026-09-25)**.
- Piece 1 (AP discovery): verified in QEMU and on Dell 5590 ([smp-piece1-ap-discovery.md](../roadmap/smp-piece1-ap-discovery.md)).
- Piece 2 (per-CPU storage): verified in QEMU and on Dell 5590 ([smp-piece2-percpu.md](../roadmap/smp-piece2-percpu.md)).
- Piece 3 (lock discipline & contention): verified in QEMU and on Dell 5590 ([smp-piece3-lock-discipline.md](../roadmap/smp-piece3-lock-discipline.md)).
- Piece 4 (scheduler & work-stealing): verified in QEMU and on Dell 5590 ([smp-piece4-scheduler.md](../roadmap/smp-piece4-scheduler.md)).
- Piece 5 (cross-core IPIs & TLB shootdown): verified in QEMU and on Dell 5590 ([smp-piece5-ipi.md](../roadmap/smp-piece5-ipi.md)).
- Piece 6 (memory architecture: 6A boot ceiling/OOM, 6B PMM stress, 6C deadlock-safe TLB shootdown/CR3 reload, 6D address space lifetime/deferred reaping): verified in QEMU and on Dell 5590 ([smp-piece6-memory.md](../roadmap/smp-piece6-memory.md)).

This document is preserved for architectural reference, design invariants (`SM1`–`SM16`), and design intent. Current implementation status and verification evidence are recorded in [`docs/roadmap/`](../roadmap/README.md) and [`AGENTS.md`](../../AGENTS.md).
