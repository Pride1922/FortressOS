#ifndef FORTRESS_FONT_H
#define FORTRESS_FONT_H
...
/* Standard 8x16 bitmap font glyphs for printable ASCII 0x20 (space) through 0x7E (~) */
static const uint8_t g_font_8x16[95][16] = {
    ...
    /* 0x25: % */
    {0x00,0x00,0xC6,0xCC,0x18,0x30,0x60,0xC6,0xCC,0x18,0x30,0x60,0x00,0x00,0x00,0x00},
    /* 0x26: & */
    ...
    /* 0x3B: ; */
    {0x00,0x00,0x18,0x18,0x00,0x00,0x00,0x00,0x18,0x18,0x18,0x30,0x00,0x00,0x00,0x00},
    /* 0x3C: < */
    ...
    /* 0x40: @ */
    {0x00,0x7C,0xC6,0xDE,0xDA,0xDA,0xDE,0xC0,0xC0,0xC6,0x7C,0x00,0x00,0x00,0x00,0x00},
    /* 0x41: A */
    ...
    /* 0x47: G */
    {0x00,0x3C,0x66,0xC2,0xC0,0xC0,0xCE,0xC6,0xC6,0x66,0x3A,0x00,0x00,0x00,0x00,0x00},
    /* 0x48: H */
    {0x00,0xC6,0xC6,0xC6,0xC6,0xFE,0xC6,0xC6,0xC6,0xC6,0xC6,0x00,0x00,0x00,0x00,0x00},
    /* 0x49: I */
    {0x00,0x78,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x78,0x00,0x00,0x00,0x00,0x00},
    /* 0x4A: J */
    {0x00,0x1E,0x0C,0x0C,0x0C,0x0C,0x0C,0xCC,0xCC,0xCC,0x78,0x00,0x00,0x00,0x00,0x00},
    /* 0x4B: K */
    {0x00,0xE6,0x66,0x6C,0x68,0x78,0x6C,0x66,0x66,0x66,0xE6,0x00,0x00,0x00,0x00,0x00},
    /* 0x4C: L */
    ...
    /* 0x51: Q */
    {0x00,0x7C,0xC6,0xC6,0xC6,0xC6,0xC6,0xC6,0xD6,0xDE,0x7C,0x0E,0x00,0x00,0x00,0x00},
    /* 0x52: R */
    ...
    /* 0x56: V */
    {0x00,0xC6,0xC6,0xC6,0xC6,0xC6,0xC6,0x6C,0x6C,0x38,0x10,0x00,0x00,0x00,0x00,0x00},
    /* 0x57: W */
    {0x00,0xC6,0xC6,0xC6,0xC6,0xD6,0xD6,0xFE,0xEE,0x6C,0x28,0x00,0x00,0x00,0x00,0x00},
    /* 0x58: X */
    ...
    /* 0x62: b */
    {0x00,0xE0,0x60,0x60,0x78,0x6C,0x66,0x66,0x66,0x6C,0xF8,0x00,0x00,0x00,0x00,0x00},
    /* 0x63: c */
    ...
    /* 0x69: i */
    {0x00,0x18,0x18,0x00,0x78,0x18,0x18,0x18,0x18,0x18,0x7E,0x00,0x00,0x00,0x00,0x00},
    /* 0x6A: j */
    {0x00,0x0C,0x0C,0x00,0x1C,0x0C,0x0C,0x0C,0x0C,0x0C,0x0C,0xCC,0x78,0x00,0x00,0x00},
    /* 0x6B: k */
    ...
    /* 0x6D: m */
    {0x00,0x00,0x00,0x00,0xFE,0xD6,0xD6,0xD6,0xD6,0xD6,0xD6,0x00,0x00,0x00,0x00,0x00},
    /* 0x6E: n */
    ...
    /* 0x70: p */
    {0x00,0x00,0x00,0x00,0xF8,0x6C,0x66,0x66,0x66,0x6C,0x78,0x60,0x60,0xF0,0x00,0x00},
    /* 0x71: q */
    ...
    /* 0x73: s */
    {0x00,0x00,0x00,0x00,0x7C,0xC6,0x70,0x1C,0x06,0xC6,0x7C,0x00,0x00,0x00,0x00,0x00},
    /* 0x74: t */
    {0x00,0x30,0x30,0x30,0xFC,0x30,0x30,0x30,0x30,0x34,0x18,0x00,0x00,0x00,0x00,0x00},
    /* 0x75: u */
...
/* Default solid block for non-printable characters or cursor */
static const uint8_t g_font_block[16] = {
...
static inline const uint8_t *font_get_glyph(char c) {
    if (c >= 0x20 && c <= 0x7E) {
        return g_font_8x16[(uint8_t)c - 0x20];
    }
    return g_font_block;
}

#endif /* FORTRESS_FONT_H */
